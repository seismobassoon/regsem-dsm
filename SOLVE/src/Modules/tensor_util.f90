...
integer :: i,j
doubleprecision, parameter :: s2=1.4142135623730950488d0
...
doubleprecision, parameter :: os2=.70710678118654d0
...
lambda_from_Cij = ( C(1,1) + C(2,2) + C(3,3) &
                    + 4*C(1,2) + 4*C(2,3) + 4*C(1,3) &
                    - C(4,4) - C(5,5) - C(6,6) ) / 15.
...
mu_from_Cij = ( C(1,1) + C(2,2) + C(3,3) &
              - C(1,2) - C(2,3) - C(1,3) &
              + 1.5*C(4,4) + 1.5*C(5,5) + 1.5*C(6,6) ) / 15.
