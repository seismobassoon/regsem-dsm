...
logical :: curve, aniso, ocean, ellipticity, comp_rot, adjoint, save_trace, save_snapshots
...
integer :: n_source, n_dime, n_glob_nodes, n_mat, n_nodes, n_receivers, n_proc, &
           ...
           t_reversal_mirror, recl_mirror, nb_simu, n_source_adj

doubleprecision :: T1_att, T2_att, T0_modele
